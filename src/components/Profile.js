...
export default function Profile({ username = "newk3d" }) {
  return (
    <ProfileEl>
        <Head>
            <title>Cryto.com NFT Marketplace</title>
        </Head>
        <Cover>
            <Image src="/images/cover/newk3d.png" 
              layout="fill"
            />
        </Cover>
        <Content>
            <Info>
                ...
                <Bio>
                    {`Newk3d is a Norwegian 3D artist with a passion for digital art and creating in general. His style consists of flashy iridescent metals that catches the eye. He is influenced by a wide array of topics, from fantasy to cyberpunk. He has been pushing himself creatively by making new art every single day for over 600 days.`}
                </Bio>
                <Socials>
                    <a href="#">
                    <GrTwitter />
